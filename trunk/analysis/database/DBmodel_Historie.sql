Database:  localhost:C:/Program Files/Firebird/Firebird_1_5/database/plantLore2.fdb, User: SYSDBA

SET SQL DIALECT 3;

/* CREATE DATABASE 'localhost:C:/Program Files/Firebird/Firebird_1_5/database/plantLore2.fdb' DEFAULT CHARACTER SET ISO8859_2 */
...
CREATE TABLE TOCCURENCES (CID INTEGER NOT NULL,
        ...
        CCREATEDWHO INTEGER NOT NULL,
        CUPDATEDWHO INTEGER NOT NULL,
        CNOTE VARCHAR(4096),
PRIMARY KEY (CID));
