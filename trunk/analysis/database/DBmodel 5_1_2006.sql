...
CREATE TABLE TAUTHORS (CID INTEGER NOT NULL,
        CFIRSTNAME VARCHAR(30) CHARACTER SET UNICODE_FSS NOT NULL,
        CSURNAME VARCHAR(30) CHARACTER SET UNICODE_FSS NOT NULL,
        CWHOLENAME VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CORGANIZATION VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CROLE VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CADDRESS VARCHAR(255) CHARACTER SET UNICODE_FSS,
        CPHONENUMBER VARCHAR(30) CHARACTER SET UNICODE_FSS,
        CEMAIL VARCHAR(100) CHARACTER SET UNICODE_FSS,
        CURL VARCHAR(100) CHARACTER SET UNICODE_FSS,
        CNOTE VARCHAR(256) CHARACTER SET UNICODE_FSS,
PRIMARY KEY (CID));
...
CREATE TABLE THABITATS (CID INTEGER NOT NULL,
        ...
        CQUADRANT VARCHAR(10) CHARACTER SET UNICODE_FSS,
        CDESCRIPTION VARCHAR(255) CHARACTER SET UNICODE_FSS,
        CNEARESTVILLAGEID INTEGER NOT NULL,
        CCOUNTRY VARCHAR(30) CHARACTER SET UNICODE_FSS,
        CALTITUDE DECIMAL(6, 2) CHARACTER SET UNICODE_FSS,
        CGPSID INTEGER,
        CNOTE VARCHAR(4096) CHARACTER SET UNICODE_FSS,
PRIMARY KEY (CID));
...
CREATE TABLE THISTORY (CID INTEGER NOT NULL,
        ...
        COLDVALUE VARCHAR(4096) CHARACTER SET UNICODE_FSS NOT NULL,
        CNEWVALUE VARCHAR(4096) CHARACTER SET UNICODE_FSS,
PRIMARY KEY (CID));

/* Table: THISTORYCHANGE, Owner: SYSDBA */
CREATE TABLE THISTORYCHANGE (CID INTEGER NOT NULL,
        CRECORDID INTEGER NOT NULL,
        COPERATION VARCHAR(20) CHARACTER SET UNICODE_FSS  NOT NULL,
...
CREATE TABLE THISTORYCOLUMN (CID INTEGER NOT NULL,
        CTABLENAME VARCHAR(20) CHARACTER SET UNICODE_FSS NOT NULL,
        CCOLUMNNAME VARCHAR(20) CHARACTER SET UNICODE_FSS NOT NULL,
PRIMARY KEY (CID));

/* Table: TMETADATA, Owner: SYSDBA */
CREATE TABLE TMETADATA (CID INTEGER NOT NULL,
        CTECHNICALCONTACTNAME VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CCONTENTCONTACTNAME VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CDATASETTITLE VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CSOURCEINSTITUTIONID VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CSOURCEID VARCHAR(50) CHARACTER SET UNICODE_FSS,
        COWNERORGANIZATIONABBREV VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CDATECREATE TIMESTAMP,
        CDATEMODIFIED TIMESTAMP,
        CLANGUAGE VARCHAR(10) CHARACTER SET UNICODE_FSS,
        CRECORDBASIS VARCHAR(15) CHARACTER SET UNICODE_FSS,
PRIMARY KEY (CID));

/* Table: TOCCURENCES, Owner: SYSDBA */
CREATE TABLE TOCCURENCES (CID INTEGER NOT NULL, 
        CUNITIDDB VARCHAR(30) CHARACTER SET UNICODE_FSS,
        CUNITVALUE VARCHAR(30) CHARACTER SET UNICODE_FSS,     
        ...
        CTIMECOLLECTED TIME,
        CDATESOURCE VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CPUBLICATIONSID INTEGER,
        CHERBARIUM VARCHAR(20) CHARACTER SET UNICODE_FSS,
...
CREATE TABLE TPHYTOCHORIA (CID INTEGER NOT NULL,
        CCODE VARCHAR(5) CHARACTER SET UNICODE_FSS NOT NULL,
        CNAME VARCHAR(50) CHARACTER SET UNICODE_FSS NOT NULL,
PRIMARY KEY (CID));

/* Table: TPLANTS, Owner: SYSDBA */
CREATE TABLE TPLANTS (CID INTEGER NOT NULL,
        CADOPTEDNAME VARCHAR(30) CHARACTER SET UNICODE_FSS NOT NULL,
        CCZECHNAME VARCHAR(30) CHARACTER SET UNICODE_FSS,
        CPUBLISHABLENAME VARCHAR(30) CHARACTER SET UNICODE_FSS,
        CABBREVIATION VARCHAR(15) CHARACTER SET UNICODE_FSS,
        CNOTE VARCHAR(256) CHARACTER SET UNICODE_FSS,
PRIMARY KEY (CID));

/* Table: TPUBLICATIONS, Owner: SYSDBA */
CREATE TABLE TPUBLICATIONS (CID INTEGER NOT NULL,
        CCOLLECTIONNAME VARCHAR(30) CHARACTER SET UNICODE_FSS,
        CCOLLECTIONYEARPUBLICATION INTEGER,
        CJOURNALNAME VARCHAR(60) CHARACTER SET UNICODE_FSS,
        CJOURNALAUTHORNAME VARCHAR(30) CHARACTER SET UNICODE_FSS,
PRIMARY KEY (CID));

/* Table: TTERRITORIES, Owner: SYSDBA */
CREATE TABLE TTERRITORIES (CID INTEGER NOT NULL,
        CNAME VARCHAR(100) CHARACTER SET UNICODE_FSS NOT NULL,
PRIMARY KEY (CID));

/* Table: TUSER, Owner: SYSDBA */
CREATE TABLE TUSER (CID INTEGER NOT NULL,
        CLOGIN VARCHAR(20) NOT NULL,
        CFIRSTNAME VARCHAR(20) CHARACTER SET UNICODE_FSS,
        CSURNAME VARCHAR(30) CHARACTER SET UNICODE_FSS,
        CEMAIL VARCHAR(50) CHARACTER SET UNICODE_FSS,
        CADDRESS VARCHAR(50) CHARACTER SET UNICODE_FSS,
