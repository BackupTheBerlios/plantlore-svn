Database:  localhost:C:/Program Files/Firebird/Firebird_1_5/Database/hibrenateTest/plantloreHIB.fdb, User: SYSDBA

SET SQL DIALECT 3;

/* CREATE DATABASE 'localhost:C:/Program Files/Firebird/Firebird_1_5/Database/hibrenateTest/plantloreHIB.fdb' DEFAULT CHARACTER SET UNICODE_FSS */
...
CREATE TABLE TAUTHORSOCCURRENCES (CAUTHORID INTEGER NOT NULL,
...
CREATE TABLE TOCCURRENCES (CID INTEGER NOT NULL,
...
CREATE TABLE TPUBLICATIONS (CID INTEGER NOT NULL,
        ...
        CREFERENCECITATION VARCHAR(255),
        CREFERENCEDETAIL VARCHAR(20),
        CURL VARCHAR(100),                
PRIMARY KEY (CID));

/* Table: TRIGHT, Owner: SYSDBA */
CREATE TABLE TRIGHT (CID INTEGER NOT NULL,
        CADMINISTRATOR INTEGER,
        CEDITALL INTEGER,
        CEDITOWEN INTEGER,
        CEDITGROUP VARCHAR(255),
        CEXPORT INTEGER,
        CIMPORT INTEGER,
        CROLE VARCHAR(20),
PRIMARY KEY (CID));
