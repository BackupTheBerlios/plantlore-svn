Database:  localhost:C:/Program Files/Firebird/Firebird_1_5/database/plantloreDBunicode.fdb, User: SYSDBA

SET SQL DIALECT 3;

/* CREATE DATABASE 'localhost:C:/Program Files/Firebird/Firebird_1_5/database/plantloreDBunicode.fdb' DEFAULT CHARACTER SET UNICODE_FSS */
...
CREATE TABLE TAUTHORS (CID INTEGER NOT NULL,
        ...
        CIDENTIFICATIONAUTHOR VARCHAR(50),
...
CREATE TABLE TOCCURENCES (CID INTEGER NOT NULL,
        CGLOBALUNIQUEIDENTIFIER VARCHAR(30),
